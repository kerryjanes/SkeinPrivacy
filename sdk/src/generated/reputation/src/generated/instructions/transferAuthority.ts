...
export const TRANSFER_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  48, 169, 76, 72, 229, 180, 55, 161,
]);

export function getTransferAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(TRANSFER_AUTHORITY_DISCRIMINATOR);
}
...
>(
  input: TransferAuthorityAsyncInput<TAccountAuthority, TAccountConfig>,
  config?: { programAddress?: TProgramAddress },
): Promise<TransferAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountConfig>> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as TransferAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountConfig>);
}
...
export function getTransferAuthorityInstruction<
  ...
  TProgramAddress extends Address = typeof REPUTATION_PROGRAM_ADDRESS,
>(
  input: TransferAuthorityInput<TAccountAuthority, TAccountConfig>,
  config?: { programAddress?: TProgramAddress },
): TransferAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountConfig> {
  // Program address.
  const programAddress = config?.programAddress ?? REPUTATION_PROGRAM_ADDRESS;
