...
export function getSetAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SET_AUTHORITY_DISCRIMINATOR);
}
...
>(
  input: SetAuthorityAsyncInput<TAccountAuthority, TAccountRegistry>,
  config?: { programAddress?: TProgramAddress },
): Promise<SetAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountRegistry>> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as SetAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountRegistry>);
}
...
export function getSetAuthorityInstruction<
  ...
  TProgramAddress extends Address = typeof NODE_REGISTRY_PROGRAM_ADDRESS,
>(
  input: SetAuthorityInput<TAccountAuthority, TAccountRegistry>,
  config?: { programAddress?: TProgramAddress },
): SetAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountRegistry> {
  // Program address.
  const programAddress = config?.programAddress ?? NODE_REGISTRY_PROGRAM_ADDRESS;
