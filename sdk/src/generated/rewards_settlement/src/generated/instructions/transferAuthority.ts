...
>(
  input: TransferAuthorityAsyncInput<TAccountAuthority, TAccountDistributor>,
  config?: { programAddress?: TProgramAddress },
): Promise<TransferAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountDistributor>> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as TransferAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountDistributor>);
}
...
export function getTransferAuthorityInstruction<
  ...
  TProgramAddress extends Address = typeof REWARDS_SETTLEMENT_PROGRAM_ADDRESS,
>(
  input: TransferAuthorityInput<TAccountAuthority, TAccountDistributor>,
  config?: { programAddress?: TProgramAddress },
): TransferAuthorityInstruction<TProgramAddress, TAccountAuthority, TAccountDistributor> {
  // Program address.
  const programAddress = config?.programAddress ?? REWARDS_SETTLEMENT_PROGRAM_ADDRESS;
